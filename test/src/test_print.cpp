...
TEST(Print, redirectPrint) {
    ...
    M->x[0] = 1.2; M->x[1] = 4.5; M->x[2] = -2; M->x[3] = -3; M->x[4] = 3.25; M->x[5] = 1.2; M->x[6] = 1.5; M->x[7] = 1.125; M->x[8] = 1.75; M->x[9] = 0.5; M->x[10] = -0.5;
    // clang-format on
